...
}:
{
  programs.plasma = {
    ...
    configFile = {
      ...
      "kwinrc"."NightColor"."NightTemperature" = 1200;
      "kwinrc"."Plugins"."wobblywindowsEnabled" = true;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling.250b82cb-c8d2-50e6-91f9-1fb3d4d4d06b"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "plasma-localerc"."Formats"."LC_MONETARY" = "en_NL.UTF-8";
